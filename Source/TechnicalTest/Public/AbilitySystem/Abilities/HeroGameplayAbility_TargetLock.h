 ...
 */
UCLASS()
class TECHNICALTEST_API UHeroGameplayAbility_TargetLock : public UHeroGameplayAbility
{
	GENERATED_BODY()
...
private:
	...
	AActor* GetNearestActorFromAvailableActors(const TArray<AActor*>& InAvailableActors);
