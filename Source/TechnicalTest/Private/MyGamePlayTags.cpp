...
namespace MyGamePlayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_GetHitWhileRolling, "Player.Event.GetHitWhileRolling");
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_SuccessfulDodge, "Player.Event.SuccessfulDodge");
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_ResetCounter, "Player.Event.ResetCounter");
	...
	UE_DEFINE_GAMEPLAY_TAG(Enemy_Event_ReducePoise, "Enemy.Event.ReducePoise");

	/** Shared tags **/
	UE_DEFINE_GAMEPLAY_TAG(Shared_Ability_HitReact, "Shared.Ability.HitReact");
	UE_DEFINE_GAMEPLAY_TAG(Shared_Ability_Death, "Shared.Ability.Death");
	UE_DEFINE_GAMEPLAY_TAG(Shared_Ability_Stuned, "Shared.Ability.Stuned");
