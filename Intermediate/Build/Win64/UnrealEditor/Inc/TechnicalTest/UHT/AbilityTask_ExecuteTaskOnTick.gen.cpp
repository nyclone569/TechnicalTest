...
TECHNICALTEST_API UClass* Z_Construct_UClass_UAbilityTask_ExecuteTaskOnTick();
...
struct Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics
{
	struct _Script_TechnicalTest_eventOnAbilityTaskTickDelegate_Parms
	{
		float Deltatime;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::NewProp_Deltatime = { "Deltatime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_TechnicalTest_eventOnAbilityTaskTickDelegate_Parms, Deltatime), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::NewProp_Deltatime,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_TechnicalTest, nullptr, "OnAbilityTaskTickDelegate__DelegateSignature", Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::_Script_TechnicalTest_eventOnAbilityTaskTickDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::_Script_TechnicalTest_eventOnAbilityTaskTickDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_TechnicalTest_OnAbilityTaskTickDelegate__DelegateSignature_Statics::FuncParams);
	}
...
void FOnAbilityTaskTickDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnAbilityTaskTickDelegate, float Deltatime)
{
	...
	_Script_TechnicalTest_eventOnAbilityTaskTickDelegate_Parms Parms;
...
FClassRegistrationInfo Z_Registration_Info_UClass_UAbilityTask_ExecuteTaskOnTick;
UClass* UAbilityTask_ExecuteTaskOnTick::GetPrivateStaticClass()
{
	using TClass = UAbilityTask_ExecuteTaskOnTick;
	if (!Z_Registration_Info_UClass_UAbilityTask_ExecuteTaskOnTick.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AbilityTask_ExecuteTaskOnTick"),
			Z_Registration_Info_UClass_UAbilityTask_ExecuteTaskOnTick.InnerSingleton,
			StaticRegisterNativesUAbilityTask_ExecuteTaskOnTick,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UAbilityTask_ExecuteTaskOnTick.InnerSingleton;
}
UClass* Z_Construct_UClass_UAbilityTask_ExecuteTaskOnTick_NoRegister()
{
	return UAbilityTask_ExecuteTaskOnTick::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UAbilityTask_ExecuteTaskOnTick_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UAbilityTask_ExecuteTaskOnTick_ExecuteTaskOnTick, "ExecuteTaskOnTick" }, // 3675253880
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Projects_Unreal_TechnicalTest_Source_TechnicalTest_Public_AbilitySystem_AbilityTasks_AbilityTask_ExecuteTaskOnTick_h__Script_TechnicalTest_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_ExecuteTaskOnTick, UAbilityTask_ExecuteTaskOnTick::StaticClass, TEXT("UAbilityTask_ExecuteTaskOnTick"), &Z_Registration_Info_UClass_UAbilityTask_ExecuteTaskOnTick, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_ExecuteTaskOnTick), 2096807021U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Unreal_TechnicalTest_Source_TechnicalTest_Public_AbilitySystem_AbilityTasks_AbilityTask_ExecuteTaskOnTick_h__Script_TechnicalTest_2968098228(TEXT("/Script/TechnicalTest"),
	Z_CompiledInDeferFile_FID_Projects_Unreal_TechnicalTest_Source_TechnicalTest_Public_AbilitySystem_AbilityTasks_AbilityTask_ExecuteTaskOnTick_h__Script_TechnicalTest_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_Unreal_TechnicalTest_Source_TechnicalTest_Public_AbilitySystem_AbilityTasks_AbilityTask_ExecuteTaskOnTick_h__Script_TechnicalTest_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
