...
struct Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics
{
	struct _Script_TechnicalTest_eventOnCounterStackChanged_Parms
	{
		int32 NewValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::NewProp_NewValue = { "NewValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_TechnicalTest_eventOnCounterStackChanged_Parms, NewValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::NewProp_NewValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_TechnicalTest, nullptr, "OnCounterStackChanged__DelegateSignature", Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::_Script_TechnicalTest_eventOnCounterStackChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::_Script_TechnicalTest_eventOnCounterStackChanged_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnCounterStackChanged_DelegateWrapper(const FMulticastScriptDelegate& OnCounterStackChanged, int32 NewValue)
{
	struct _Script_TechnicalTest_eventOnCounterStackChanged_Parms
	{
		int32 NewValue;
	};
	_Script_TechnicalTest_eventOnCounterStackChanged_Parms Parms;
	Parms.NewValue=NewValue;
	OnCounterStackChanged.ProcessMulticastDelegate<UObject>(&Parms);
}
...
struct Z_Construct_UClass_UPawnUIComponent_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OnCurrentCounterStackChanged_MetaData[] = {
		{ "ModuleRelativePath", "Public/Components/UI/PawnUIComponent.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnCurrentHealthChanged;
	static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnCurrentCounterStackChanged;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UPawnUIComponent_Statics::NewProp_OnCurrentCounterStackChanged = { "OnCurrentCounterStackChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPawnUIComponent, OnCurrentCounterStackChanged), Z_Construct_UDelegateFunction_TechnicalTest_OnCounterStackChanged__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnCurrentCounterStackChanged_MetaData), NewProp_OnCurrentCounterStackChanged_MetaData) }; // 1787706722
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPawnUIComponent_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPawnUIComponent_Statics::NewProp_OnCurrentCounterStackChanged,
};
...
struct Z_CompiledInDeferFile_FID_Projects_Unreal_TechnicalTest_Source_TechnicalTest_Public_Components_UI_PawnUIComponent_h__Script_TechnicalTest_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPawnUIComponent, UPawnUIComponent::StaticClass, TEXT("UPawnUIComponent"), &Z_Registration_Info_UClass_UPawnUIComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPawnUIComponent), 1672180449U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Unreal_TechnicalTest_Source_TechnicalTest_Public_Components_UI_PawnUIComponent_h__Script_TechnicalTest_73470840(TEXT("/Script/TechnicalTest"),
