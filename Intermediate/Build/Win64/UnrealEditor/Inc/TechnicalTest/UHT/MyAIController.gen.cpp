...
void Z_Construct_UClass_AMyAIController_Statics::NewProp_bEnableDetourCrowdAvoidance_SetBit(void* Obj)
{
	((AMyAIController*)Obj)->bEnableDetourCrowdAvoidance = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AMyAIController_Statics::NewProp_bEnableDetourCrowdAvoidance = { "bEnableDetourCrowdAvoidance", nullptr, (EPropertyFlags)0x0040000000010001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AMyAIController), &Z_Construct_UClass_AMyAIController_Statics::NewProp_bEnableDetourCrowdAvoidance_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bEnableDetourCrowdAvoidance_MetaData), NewProp_bEnableDetourCrowdAvoidance_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AMyAIController_Statics::NewProp_DetourCrowdAvoidanceQuality = { "DetourCrowdAvoidanceQuality", nullptr, (EPropertyFlags)0x0040000000010001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMyAIController, DetourCrowdAvoidanceQuality), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DetourCrowdAvoidanceQuality_MetaData), NewProp_DetourCrowdAvoidanceQuality_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMyAIController_Statics::NewProp_CollisionQueryRange = { "CollisionQueryRange", nullptr, (EPropertyFlags)0x0040000000010001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMyAIController, CollisionQueryRange), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CollisionQueryRange_MetaData), NewProp_CollisionQueryRange_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMyAIController_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyAIController_Statics::NewProp_bEnableDetourCrowdAvoidance,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyAIController_Statics::NewProp_DetourCrowdAvoidanceQuality,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyAIController_Statics::NewProp_CollisionQueryRange,
};
...
struct Z_CompiledInDeferFile_FID_Projects_Unreal_TechnicalTest_Source_TechnicalTest_Public_Controllers_MyAIController_h__Script_TechnicalTest_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMyAIController, AMyAIController::StaticClass, TEXT("AMyAIController"), &Z_Registration_Info_UClass_AMyAIController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMyAIController), 1031745846U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Unreal_TechnicalTest_Source_TechnicalTest_Public_Controllers_MyAIController_h__Script_TechnicalTest_4127941512(TEXT("/Script/TechnicalTest"),
